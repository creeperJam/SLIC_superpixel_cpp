...
The command to run it is: Linux: `./SLIC_superpixel_cpp /abs/path/to/image num_of_superpixel` - Windows `SLIC_superpixel_cpp.exe /abs/path/to/image num_of_superpixel`
